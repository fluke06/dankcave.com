...
<div class="dc-review">
	...
	<div class="dc-review__totals">
		...
		<?php
		/**
		 * Original site didn't expose shipping-method choice at checkout. Fire
		 * the action hooks so payment gateways / analytics that listen on them
		 * still run, but skip the inline row.
		 */
